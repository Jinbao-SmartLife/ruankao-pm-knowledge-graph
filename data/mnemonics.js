...
window.MNEMONICS_DATA = [
  ...
  },
  {
    ...
    title: "分析是工具，决策是输出",
    mnemonic: "分析是工具，决策是输出，例如自制外购分析",
    expansion: "在PMBOK中，数据分析类(偏差分析、趋势分析等)属于工具技术，而决策类(投票、多标准决策分析)也属于工具技术。但决策结果本身是输出。典型例子：自制外购分析是工具技术，分析结果帮助做出自制或外购的决策",
    relatedNodes: [],
    category: "跨领域"
  },
  {
    id: "mn-pg-output-rule",
    title: "过程组产出规律",
    mnemonic: "规划出计划，管理出报告，控制出变更",
    expansion: "规划过程组的输出多为各种计划和管理计划；执行(管理)过程组的输出多为工作绩效数据、报告和可交付成果；监控(控制)过程组的输出多为变更请求和工作绩效信息",
    relatedNodes: ["pg-2", "pg-3", "pg-4"],
    category: "跨领域"
  },
  {
    id: "mn-metric-traps",
